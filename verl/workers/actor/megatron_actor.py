...
class MegatronPPOActor(BasePPOActor):
    ...
    def forward_backward_batch(self, data: DataProto, forward_only=False, post_process_fn=None):
        ...
        def loss_func(output, data, meta_info):
            ...
            clip_higher = meta_info['clip_higher']
        ...
        def forward_step(batch_iter, model):
            ...
            if forward_only:
                ...
                meta_info = {'clip_ratio': self.config.clip_ratio, 'entropy_coeff': self.config.entropy_coeff, 'clip_higher': self.config.clip_higher}
